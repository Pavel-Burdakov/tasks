package com.github.pavelburdakov.userapp.security;
...
/**
 * Вспомгательный класс - конвертер, который получает роли из токена.
 * Поскольку роли могут быть в разных местах токена, spring security зарнее не знает где искать.
 */
